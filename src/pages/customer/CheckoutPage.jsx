...
<html><head><meta charset="UTF-8"><title>Invoice - Dodago</title>
<style>
...
<p class="footer">Distance: ${distanceKm ? distanceKm.toFixed(2) : "—"} km | Generated by Dodago</p>
</body></html>`;
    ...
    a.href = url;
    a.download = `dodago-invoice-${Date.now()}.html`;
    a.click();
